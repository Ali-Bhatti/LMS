...
class AddBundleIdToNeedleTables extends Migration
{
    ...
    public function up()
    {
        ...
        //     DB::statement("ALTER TABLE `sales` MODIFY COLUMN `type` enum('webinar','meeting','subscribe','promotion','registration_package','product','bundle') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL");
        //     $table->integer('bundle_id')->unsigned()->nullable()->after('webinar_id');
        // });
