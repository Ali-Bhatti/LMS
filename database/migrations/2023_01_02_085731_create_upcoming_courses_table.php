...
class CreateUpcomingCoursesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('faqs', function (Blueprint $table) {
            if (!Schema::hasColumn('faqs', 'bundle_id')) {
                $table->integer('bundle_id')->nullable(); // Corrected from varchar to string
            }
        ...
        Schema::table('favorites', function (Blueprint $table) {
            if (!Schema::hasColumn('favorites', 'bundle_id')) {
                $table->integer('bundle_id')->nullable(); // Corrected from varchar to string
            }
            $table->integer('upcoming_course_id')->unsigned()->nullable()->after('bundle_id');
        ...
        Schema::table('comments', function (Blueprint $table) {
            if (!Schema::hasColumn('comments', 'bundle_id')) {
                $table->integer('bundle_id')->nullable(); // Corrected from varchar to string
            }
            $table->integer('upcoming_course_id')->unsigned()->nullable()->after('bundle_id');
